...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-striped table-bordered">
            ...
            // foreach ($pdo->query($q) as $lec) {

            //     $attend_array = [$lec[1]];

            //     foreach ($pdo->query($q) as $std) {

            //         $attend_array[$lec[1]] = [$std[2] => $std[3]];
            //     }
            // }

            // print_r($attend_array);
    ...
    <script>
        $(".check").on('click', function(e) {
            ...
            // var ckeck_box_status = $(this).data("check");

            // if (ckeck_box_status == "false") {
